 ...
 */
public class FridgeFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<FridgeItem>>, Screenshotable {
  ...
  public void onLoadFinished(Loader<List<FridgeItem>> loader, List<FridgeItem> data) {
    ...
    if (data != null && data.size() > 0) {
      ...
      // set the adapter
      FridgeAdapter adapter = new FridgeAdapter((ArrayList<FridgeItem>) data, application, (MainActivity) getActivity(), bottomMargin);
      ...
      FridgeAdapter adapter = new FridgeAdapter(new ArrayList<FridgeItem>(), application, (MainActivity) getActivity(), bottomMargin);
      recyclerView.setAdapter(adapter);
      // show the empty view
