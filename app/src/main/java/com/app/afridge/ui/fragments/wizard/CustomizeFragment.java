...
public class CustomizeFragment extends Fragment implements FragmentLifecycle {
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    // set values
    String selectedType = application.getResources().getStringArray(R.array.measurement_type_array)[
      ...
      new Handler().postDelayed(new Runnable() {
        ...
        public void run() {
          ...
          if (textTitle != null && textDescription != null && !alreadyShown) {
            ...
            // set text
            textTitle.initSpanText(getString(R.string.customize_title), getResources().getColor(R.color.primary_dark));
            textDescription.initSpanText(getString(R.string.customize_description), getResources().getColor(R.color.text_secondary));
