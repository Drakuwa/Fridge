      ...
      new Handler().postDelayed(new Runnable() {
        ...
        public void run() {
          ...
          if (textTitle != null && textDescription != null && !alreadyShown) {
            ...
            // set text
            textTitle.initSpanText(getString(R.string.shopping_title), getResources().getColor(R.color.primary_dark));
            textDescription.initSpanText(getString(R.string.shopping_description), getResources().getColor(R.color.text_secondary));
