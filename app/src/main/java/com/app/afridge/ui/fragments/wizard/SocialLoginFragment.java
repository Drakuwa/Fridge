      ...
      new Handler().postDelayed(new Runnable() {
        ...
        public void run() {
          ...
          if (textTitle != null && textDescription != null && !alreadyShown) {
            ...
            // set text
            textTitle.initSpanText(getString(R.string.social_title), getResources().getColor(R.color.primary_dark));
            textDescription.initSpanText(getString(R.string.social_description), getResources().getColor(R.color.text_secondary));
            ...
            if (Common.versionAtLeast(12)) {
              AnimationsController.fadeInAndScale(imageFacebook, new OnAnimationEvent() {

                @Override
                public void onEnd() {

                  AnimationsController.fadeInAndScale(imageTwitter, new OnAnimationEvent() {

                    @Override
                    public void onEnd() {

                      AnimationsController.fadeInAndScale(imageGooglePlus);
                    }
                  });
                }
              });
