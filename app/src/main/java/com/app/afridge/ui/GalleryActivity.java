...
public class GalleryActivity extends AbstractActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            ...
            ((AdvancedTextView) toolbar.findViewById(R.id.toolbar_title))
                    .setText(getString(R.string.choose_image));
        }
    ...
    public void onLoadFinished(Loader<List<GalleryItem>> loader, List<GalleryItem> data) {
        ...
        SpinnerAdapter spinnerAdapter = new ArrayAdapter<>(getApplicationContext(),
                R.layout.item_spinner_simple, navigationList);
        ...
        galleryGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    default:
                        // select photo
                        Uri fileUri = ((GalleryItem) parent.getAdapter().getItem(position))
                                .getImageUri();
    ...
    private void chooseMediaFile() {
        ...
        if (chooseMediaIntent.resolveActivity(getPackageManager()) != null) {
            if (Build.VERSION.SDK_INT < 19) {
                startActivityForResult(Intent.createChooser(chooseMediaIntent, chooserTitle),
                        localRequestType);
            } else {
