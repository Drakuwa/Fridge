...
public class OutlineContainer extends FrameLayout implements Animatable {
  ...
  private void init() {
    ...
    mOutlinePaint.setStrokeWidth(Common.dpToPx(getResources(), 2));
    mOutlinePaint.setColor(getResources().getColor(R.color.primary));
    mOutlinePaint.setStyle(Style.STROKE);

    int padding = Common.dpToPx(getResources(), 10);
  ...
  protected void dispatchDraw(@NonNull Canvas canvas) {
    ...
    int offset = Common.dpToPx(getResources(), 5);
