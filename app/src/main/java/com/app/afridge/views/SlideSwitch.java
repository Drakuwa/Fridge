 ...
 * Slide switch
 * <p/>
 * Created by drakuwa on 3/20/15.
 */
public class SlideSwitch extends View {

  public static final int SHAPE_RECT = 1;
  public static final int SHAPE_CIRCLE = 2;
  private static final int RIM_SIZE = 6; // TODO default 6
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int width = measureDimension(100, widthMeasureSpec); // 280
    int height = measureDimension(50, heightMeasureSpec); // 140
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (shape == SHAPE_RECT) {
      paint.setColor(getResources().getColor(R.color.primary)); // TODO closed color
      ...
      paint.setColor(getResources().getColor(R.color.primary)); // Color.GREY
