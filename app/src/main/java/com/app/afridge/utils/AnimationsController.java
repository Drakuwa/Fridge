...
public class AnimationsController {
  ...
  public static void expandUp(View view, final View containerView, final int totalHeight, final int totalWidth) {
    ...
    Log.d(Log.TAG, "initialHeight: " + initialHeight + "; totalHeight: " + totalHeight + "; initialWidth: " + initialWidth + "; totalWidth: " + totalWidth);
    ...
    Animation animation = new Animation() {
      ...
      protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        if (interpolatedTime <= 1) {
          ...
          containerView.setTranslationX(totalTranslateX - totalTranslateX * interpolatedTime);
          containerView.setTranslationY(totalTranslateY - totalTranslateY * interpolatedTime);
        }
      }
  ...
  public static void scaleAndTranslateView(RectF actionBarLogoRect, RectF logoRect, View logo, final View logoText) { //, final OnAnimationEvent callback) {

    float horizontalOffset = 24; // logo.getContext().getResources().getDimension(R.dimen.splash_animation_horizontal_offset);
    float verticalOffset = 24; // logo.getContext().getResources().getDimension(R.dimen.splash_animation_vertical_offset);
  ...
  public static void reverseScaleAndTranslateView(RectF actionBarLogoRect, RectF logoRect, RectF logoTextRect, View logo, View logoText) {
    ...
    Animation animation = new Animation() {
      ...
      protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        if (interpolatedTime <= 1) {
          ...
          view.getLayoutParams().height = initialHeight + (int) (totalHeight * interpolatedTime);
          view.requestLayout();
        }
      }
    ...
    Animation animation = new Animation() {
      ...
      protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        if (interpolatedTime <= 1) {
          ...
          view.setAlpha(interpolatedTime);
          view.getLayoutParams().width = initialWidth + (int) ((finalWidth - initialWidth) * interpolatedTime);
          view.requestLayout();
        }
      }
