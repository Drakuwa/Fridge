...
public class SystemUtils {
    ...
    public static int getResourceId(Context context, String variableName, String resourceName) {
        ...
        try {
            return context.getResources()
                    .getIdentifier(variableName, resourceName, context.getPackageName());
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static Intent createCustomChooser(Context context, Intent prototype,
            String[] whiteList) {
        ...
        List<ResolveInfo> resolveInfoList = context.getPackageManager()
                .queryIntentActivities(dummyIntent, 0);
        ...
        for (ResolveInfo resolveInfo : resolveInfoList) {
            ...
            String appName = String
                    .valueOf(resolveInfo.activityInfo.loadLabel(context.getPackageManager()));
        ...
        chooserIntent = Intent
                .createChooser(targetedShareIntents.remove(targetedShareIntents.size() - 1), "");
